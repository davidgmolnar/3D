...
* **Portable Installation**: No external SDKs or packages are required to run the application.
...
* **Powerful Calculation Engine**: Run custom calculation scripts (`.CAL` files) to add, remove, or edit signals using a wide range of mathematical and logical functions.
* **Custom Chart Grids**: Set up side-by-side views to compare signals from the same or different measurements, with shared markers and time duration.
* **Multi-Process Design**: Functionally separate features open in their own responsive windows, ensuring a smooth experience on any resolution monitor.
...
## 🚀 Getting Started: Intended Workflow
...
A complete list of known issues is maintained on GitHub. When submitting a new bug report, please include the following information:

* What is the unintended behavior?
* What did you expect to happen?
* Steps to reproduce the issue.
* Attach the application log file, which can be found at `Installdir/Logs/3D.log`.
